...
<html lang="es">
  <head>
    ...
    <link rel="stylesheet" href="scripts/bootstrap-icons/font/bootstrap-icons.css"></script>
    ...
    <ul class="list-unstyled ps-0 mt-3">
      ...
      <li class="mb-1"> 
        <div class="collapse" id="account-collapse">
          ...
          <li class="border-top my-3"></li>
      <li class="ms-2 mb-1">
      <span class="d-inline-flex"><a href="prcd/sort.php" id="sesions" class="link-dark text-decoration-none"><i class="bi bi-door-closed-fill ms-2 me-2"></i>
          Cerrar Sesión
          </a></span>
      </li>
      <li class="mb-1"> 
