...
function limpiaModalTarjetonTemp(){
    ...
    document.getElementById('estadosList2').value = "";
    document.getElementById('municipiosList3').value = "";
    document.getElementById('localidades').value = "";
    document.getElementById('tipoDiscTemp').value = "";
    document.getElementById('discapacidadList2').value = "";
    ...
    document.getElementById('estadosList2').disabled = false;
    document.getElementById('municipiosList3').disabled = false;
