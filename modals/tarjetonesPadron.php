    ...
    <div class="modal fade" data-bs-backdrop="static" data-bs-keyboard="false" id="tarjetongen" tabindex="-1" aria-labelledby="generatarjeton" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-xl">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="imprimirt" data-bs-toggle="modal" data-bs-target="#qrShows" onclick="limpiaModalTarjeton();logEntregaTarjeton(1);" disabled><i class="bi bi-printer"></i> Imprimir</button>
            </div>
        </div>
    </div>
