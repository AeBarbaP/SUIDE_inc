  ...
  <nav class="navbar navbar-dark sticky-top flex-md-nowrap p-0 shadow mb-5 text-white" style="background-color: #917799;">
    ...
    <div class="navbar-nav">
      <div class="nav-item text-nowrap text-light">
        <a class="nav-link px-3 text-white" style="font-family: 'Quicksand', sans-serif;" href="prcd/sort.php" onclick="descartarCambios(5)">Cerrar Sesión</a>
      </div>
    </div>
  </nav>
    ...
    <ul class="list-unstyled ps-0 mt-3">
      ...
      <li class="mb-1"> 
        <div class="collapse" id="account-collapse">
          ...
          <li class="border-top my-3"></li>
          <li class="ms-2 mb-1">
          <span class="d-inline-flex"><a href="prcd/sort.php" id="linkHome" class="link-dark text-decoration-none" onclick="descartarCambios(5)"><i class="bi bi-door-closed-fill ms-2 me-2"></i>
          Cerrar Sesión
          </a></span>
      </li>
      <li class="mb-1"> 
                ...
                <div class="row ms-4 g-3 mt-3" style="width:95%">
                  ...
                  <br>
                    <div class="d-grid gap-2 mt-3">
                      <button class="btn btn-primary" type="submit" id="btnGuardarGeneral" disabled>Guardar</button>
                  ...
                  <div class="row g-3 ms-4 mt-3 row-cols-1" style="width:95%">
                    <div class="col-sm-12 mt-3 p-4">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="d-grid gap-2 mt-3">
                          <button class="btn btn-secondary" type="button" onclick="buscarExpediente3()" disabled><i class="bi bi-person-badge me-2"></i> Entregar Tarjetón</button>
                          </div>
                        </div>
                      </div>
                    </div>
