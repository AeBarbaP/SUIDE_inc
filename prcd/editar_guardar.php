...
$nombreInformante = $_POST['nombreInformante'];
$relacionInformante = $_POST['relacionInformante'];
$otrarelacionInformante = $_POST['otrarelacionInformante'];
$seguridadsocial = $_POST['seguridadsocial'];
$otroSS = $_POST['otroSS'];
$numSS = $_POST['numSS'];
$gruposFull = $_POST['grupovulnerableFull'];
...
if ($curp != "" || $curp != null){
    $sqlinsert= "UPDATE datos_generales SET 
        ...
        informante = '$nombreInformante',
        informante_parentesco = '$informanteRelacion',
        otro_parentesco = '$otrarelacionInformante',
    ...
    $sqlinsert= "UPDATE datos_generales SET 
        ...
        pension_temporalidad = '$pensionTemporalidad',
        informante = '$nombreInformante',
        informante_parentesco = '$relacionInformante',
        otro_parentesco = '$otrarelacionInformante',
        seguridad_social = '$seguridadsocial',
        seguridad_social_otro = '$otroSS',
        estatus = '$estatus',
