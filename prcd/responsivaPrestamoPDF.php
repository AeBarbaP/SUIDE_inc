...
$pdf->Multicell(170,5,utf8_decode('Entiendo que el tarjetón debe colocarse en el vehículo únicamente al utilizar un cajón de estacionamiento exclusivo para personas con discapacidad. Se recomienda retirarlo cuando no se haga uso de dicho espacio, con el fin de evitar su deterioro o maltrato'),0,'J',0);
$pdf->Cell(5,5,utf8_decode(' '),0,0,'L');
$pdf->Cell(10,5,utf8_decode('VII.'),0,0,'L');
$pdf->Multicell(170,5,utf8_decode('La reposición del tarjetón únicamente procederá en los siguientes casos: Extravío o Robo.'),0,'J',0);
$pdf->Cell(5,5,utf8_decode(' '),0,0,'L');
$pdf->Cell(10,5,utf8_decode(' '),0,0,'L');
$pdf->Multicell(170,5,utf8_decode('Cuando el daño se limite al código QR o al número de expediente, únicamente se reimprimirán las etiquetas correspondientes, sin necesidad de generar un nuevo tarjetón.'),0,'J',0);
$pdf->Cell(5,5,utf8_decode(' '),0,0,'L');
$pdf->Cell(10,5,utf8_decode('VIII.'),0,0,'L');
