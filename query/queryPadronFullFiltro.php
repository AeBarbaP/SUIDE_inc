...
if ($flag == 2){
    ...
    if ($option == 1){
        ...
        $var = "SELECT datos_generales.numExpediente AS id, datos_generales.nombre AS nombre, datos_generales.id AS id2, datos_generales.apellido_p AS apellido_p, datos_generales.apellido_m AS apellido_m, datos_generales.municipio AS municipio, datos_generales.estatus AS estatus, datos_generales.photo AS photo, datos_medicos.tipo_discapacidad AS tipo_discapacidad FROM datos_generales INNER JOIN datos_medicos ON datos_generales.numExpediente = datos_medicos.expediente WHERE datos_generales.id = '$id'";
    }
    else if ($option == 2){
        ...
        $var = "SELECT datos_generales.nombre AS nombre, datos_generales.apellido_p AS apellido_p, datos_generales.apellido_m AS apellido_m WHERE CONCAT(datos_generales.nombre,' ', datos_generales.apellido_p,' ', datos_generales.apellido_m) = '%$id%'";
    }
